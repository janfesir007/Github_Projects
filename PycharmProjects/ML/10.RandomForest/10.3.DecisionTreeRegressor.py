...
from sklearn.ensemble import RandomForestRegressor,AdaBoostRegressor,ExtraTreesRegressor  # 这些都可以做回归曲线拟合
...
if __name__ == "__main__":
    ...
    # 随机森林回归拟合曲线,还有AdaBoostRegressor,ExtraTreesRegressor
    reg1 = RandomForestRegressor()
    dt1 = reg1.fit(x, y)
    y_hat1 = dt1.predict(x_test)

    plt.plot(x, y, 'r*', linewidth=2, label='Actual')
    plt.plot(x_test, y_hat1, 'g-', linewidth=2, label='Predict')
